...
from ..sleep.llm_providers import BaseLLMProvider, create_llm_providers
...
class WorldModelParser(LLMResponseParser):
    ...
    def parse(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"Failed to parse world model response as JSON: {e}, using fallback parser")
...
class LLMService:
    ...
    async def enhance_prompt(self, original_prompt: str, context: Dict[str, Any]) -> LLMResponse[str]:
    ...
    async def analyze_patterns(self, interactions: List[Dict[str, Any]]) -> LLMResponse[Dict[str, Any]]:
