...
class WorldState:
    ...
    def add_relation(self, source_id: str, target_id: str, 
                    relation_type: str, **properties) -> Relation:
...
class WorldModelInferencer:
    ...
    def _update_metrics(self, interaction: Dict[str, Any]):
        ...
        self.current_world.metrics["entity_type_diversity"] = len(self.current_world.discovered_entity_types)
        self.current_world.metrics["relation_type_diversity"] = len(self.current_world.discovered_relation_types)
        
    async def merge_with_existing(self, existing_world: Dict[str, Any]) -> WorldState:
        """Merge current world with existing semantic memory.
        
        This method would use LLM to intelligently merge world models,
        resolving conflicts and strengthening common patterns.
        """
        # TODO: Implement LLM-based merging
        # For now, just return current world
        return self.current_world
