    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.error(
                    f"Tool '{name}' failed with {type(e).__name__}", extra=extra, exc_info=True
                )
...
def mcp_resource_logger(resource_name: Optional[str] = None):
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            extra = {"resource": name, "timestamp": datetime.now().isoformat()}
            ...
            try:
                ...
                logger.error(f"Resource '{name}' failed", extra=extra, exc_info=True)
